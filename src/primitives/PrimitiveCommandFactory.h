...
{
public:
    static PrimitiveCommand *createCommand(const std::string &commandType, const std::vector<float> &args)
    {
        ...
        {
            auto ellipsoid = new EllipsoidCommand(glm::vec3{args[0], args[1], args[2]});
            return ellipsoid;
        }
